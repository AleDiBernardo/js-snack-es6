...
const result = valuesBetweenPosition(array, a, b);
console.log(result);
 ...
 * @returns {[]}
 */
function valuesBetweenPosition(array, a, b) {

  const valuesBetweenPosition = array.filter((valore, indice) => indice > a && indice < b);

  return valuesBetweenPosition;
}